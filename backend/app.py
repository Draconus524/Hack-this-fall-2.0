...
cors = CORS(app, resources={r"/get_precipitation": {"origins": "http://192.168.56.1:3000"}, r"/get_temperature": {"origins": "http://192.168.56.1:3000"}})
...
@cross_origin(origin='http://192.168.56.1',headers=['Content- Type','Authorization'])
...
@cross_origin(origin='https://192.168.56.1',headers=['Content- Type','Authorization'])
