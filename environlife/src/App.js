  ...
  const testAPI = async (lll) => {
    try {
      const r1 = await fetch(
        `http://192.168.56.1:3000/get_temperature?lat=${lll.lat}&long=${lll.lng}&end=${end}`
      );
      const response1 = await r1.json();

      const r2 = await fetch(
        `http://192.168.56.1:3000/get_precipitation?lat=${lll.lat}&long=${lll.lng}&end=${end}`
      );
      const response2 = await r2.json();

      const r3 = await fetch(
        `http://192.168.56.1:3000/get_sea_coverage?lat=${lll.lat}&long=${lll.lng}&end=${end}`
      );
      const response3 = await r3.json();

      const r4 = await fetch(
        `http://192.168.56.1:3000/get_air_quality?lat=${lll.lat}&long=${lll.lng}&end=${end}`
      );
